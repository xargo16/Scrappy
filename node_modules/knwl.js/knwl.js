function Knwl(language) {
	...
	//Separate function for getting phone numbers in UK format
	this.getUKPhoneNumbers = function(){
		try {
				var args = arguments;
				var data = knwl.plugins['phones'].callsUK(args);
				return data;
		} catch (error) {
				console.error('Knwl.js Error', 'Error running parser plugin phones', error);
				return false;
		}
	}
